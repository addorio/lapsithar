...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('profilekepala/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('profilekepala/ajax_add')?>";
        ...
        url = "<?php echo site_url('profilekepala/ajax_update')?>";
