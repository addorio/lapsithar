  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Rekapitulasi Laporan<span>
              <button style="float: right;" class="btn mb-1 btn-flat btn-primary" onclick="add_laporan()"><i class="glyphicon glyphicon-plus"></i> Tambah Laporan</button></span>
...
<script type="text/javascript">
  ...
  $(".buat_laporan").click(function() {
    ...
    $("#cetak-laporan").html(
      '<iframe src="{{base_url()}}userpage/cetak_laporan" width="100%" height="450" frameborder="0" ></iframe>'
    );
  });
</script>
@endsection