    ...
    {    
        ...
        foreach ($list as $laporan) {
          if ($laporan->id_opd == $id_opd) {
            ...
            $row[] = '<a class="btn btn-sm mb-1 btn-flat btn-outline-success" href="javascript:void(0)" title="Edit" onclick="edit_laporan('."'".$laporan->id_laporan."'".')"><i class="glyphicon glyphicon-pencil"></i> Ubah</a>';
            $row[] = '<a class="btn btn-sm mb-1 btn-flat btn-outline-danger" href="javascript:void(0)" title="Hapus" onclick="delete_laporan('."'".$laporan->id_laporan."'".')"><i class="glyphicon glyphicon-trash"></i> Hapus</a>';
