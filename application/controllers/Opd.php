 ...
 class Opd extends CI_Controller {  
  ...
  public function ajax_list()
  {
    ...
    foreach ($list as $person) {
      ...
      $row[] = $person->nama_opd;
      //add html for action
      $row[] = '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Edit" onclick="edit_laporan('."'".$person->id_opd."'".')"><i class="glyphicon glyphicon-pencil"></i> Edit</a>';
      $row[] = '<a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Hapus" onclick="delete_laporan('."'".$person->id_opd."'".')"><i class="glyphicon glyphicon-trash"></i> Delete</a>';
