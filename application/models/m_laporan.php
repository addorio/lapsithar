...
class M_laporan extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        if ($tanggal_mulai != '' && $tanggal_akhir != '' && $keterangan != '' && $opd != '' && $bidang) {
            ...
            $this->db->where('tb_laporan.keterangan', $keterangan);
            $this->db->where('tb_laporan.id_opd', $opd);
            $this->db->where('tb_laporan.nama_bidang', $bidang);
    ...
    {
        $sesi = [
            'keterangan_laporan' => $this->input->post('ket'),
            'opd_laporan' => $this->input->post('opd'),
            'bidang_laporan' => $this->input->post('bidang'),
