...
var $column_search = array("id_laporan", "tb_opd.id_opd", "tanggal", "judul", "nama_bidang", "isi_laporan", "tindakan", "keterangan"); //set column field database for datatable searchable   
